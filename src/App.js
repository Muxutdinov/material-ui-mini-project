   ...
   <main>
     <div className={classes.container}>
       <Container maxWidth="sm" style={{marginTop:'100px'}}>
          <Typography variant='h2'  align='center' color='textPrimary' gutterBotton>
                Photo Album
          </Typography>
           ...
           <Grid item key={value} xs={12} sm={6} md={4}>
                 {/* <Card className={classes.card}> */}
                     ...
                     <CardContent className={classes.cardContant}>
                         <Typography variant='gutterBotton' variant="h5">
                               Heading
                         </Typography>
                         <Typography>
                           This is a media card. You can use this section to describe to content.
                         </Typography>
                     </CardContent>
                     <CardActions>
